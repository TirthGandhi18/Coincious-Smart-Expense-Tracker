        ...
        <div className="p-4 md:p-6 space-y-6">
            ...
            <Card className="max-w-2xl mx-auto border-2 hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8">
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        {/* Button Section - Changed to button for S6848/S1082 */}
                        <div className="flex-shrink-0 w-full md:w-auto">
                            <Button
                                onClick={() => setShowEmailModal(true)}
                                className="w-full md:w-auto px-6 py-3 h-auto rounded-lg bg-[#8B4513] text-white font-medium hover:bg-[#6D3410] transition-colors shadow-md hover:shadow-lg"
                            >
                                Contact via Email
                            </Button>
                        </div>
            ...
            {showEmailModal && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                    ...
                    {/* Modal Content */}
                    <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md w-full shadow-2xl border border-gray-200 dark:border-gray-700 z-10">
                        <div className="flex items-center justify-between mb-6">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">Contact Support</h3>
                            <button 
                                type="button"
                                onClick={() => setShowEmailModal(false)} 
                                className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-primary"
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                className="w-full text-left p-5 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-blue-400 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all group focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
                            ...
                            <button
                                ...
                                className="w-full text-left p-5 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-purple-400 dark:hover:border-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all group focus:outline-none focus:ring-2 focus:ring-purple-500"
                            >
                                <div className="flex items-center justify-between w-full">
                                    <div className="flex items-center gap-4">
                            ...
                            <Card key={cat.id}>
                                ...
                                <CardContent>
                                    <Accordion type="single" collapsible className="w-full">
                                        {/* S6479: Removed idx from key, used unique string composition */}
                                        {cat.questions.map((q) => (
                                            <AccordionItem key={`${cat.id}-${q.question.replace(/\s+/g, '-').toLowerCase()}`} value={`${cat.id}-${q.question}`}>
